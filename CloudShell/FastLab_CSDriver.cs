//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by TestShell Driver Builder Version 7.1.0.
//
...
[assembly: AssemblyProduct("[<AssemblyName>] 7.1.0")]
[assembly: Library(typeof(FastLab_CSDriver), "", IsolationLevel.PerLibrary)]
...
namespace QualiSystems.Driver
{
    ...
    public class FastLab_CSDriver : ICancelable, IDisposable
    {
		...
		static FastLab_CSDriver()
		{
			DriverCodeBase = Assembly.GetExecutingAssembly().CodeBase;
			TestShellRuntimeLocator runtimeLocator = new TestShellRuntimeLocator("7.1.0");
        ...
        public FastLab_CSDriver()
        {
			m_DriverIdentifier = Guid.NewGuid();

			Type runtimeType = DriverRuntimeAssembly.GetType(DriverRuntimeTypeName);
			bool IsSupportedVersion = (bool)runtimeType.GetMethod("IsSupportedRuntimeVersion").Invoke(null, new object[]{"7.1.0"});
			if (!IsSupportedVersion)
				throw TestShellRuntimeLocator.NoMatchingRuntimeException("7.1.0");

			runtimeType.GetMethod("InitializeRuntime").Invoke(null, new object[]{Assembly.GetExecutingAssembly().CodeBase, "FastLab_CSDriver", m_DriverIdentifier.ToString()});
                      
			m_EntryPointFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\EntryPoint.tsdrv");
			m_SetupFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\Commands\\Setup.tsdrv");
			m_TeardownFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\Commands\\Teardown.tsdrv");
			m_Action_AssociationFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\Functions\\Action_Association.tsdrv");
			m_Action_EnvInfoFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\Functions\\Action_EnvInfo.tsdrv");
			m_Action_FreeZombiesFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\Functions\\Action_FreeZombies.tsdrv");
			m_Action_ManagePoolFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\Functions\\Action_ManagePool.tsdrv");
			m_Action_RequestFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\Functions\\Action_Request.tsdrv");
			m_Action_ResetStateFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\Functions\\Action_ResetState.tsdrv");
			m_Action_TerminateFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\Functions\\Action_Terminate.tsdrv");
			m_System_ClaimFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\Functions\\System_Claim.tsdrv");
			m_System_GetAttributeFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\Functions\\System_GetAttribute.tsdrv");
			m_System_ProvisionFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\Functions\\System_Provision.tsdrv");
			m_System_ProvisionOffClaimedFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\Functions\\System_ProvisionOffClaimed.tsdrv");
			m_System_SetAttributeFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\Functions\\System_SetAttribute.tsdrv");
			m_System_TerminateFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\Functions\\System_Terminate.tsdrv");
			m_Util_GetReservationIdFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\Functions\\Util_GetReservationId.tsdrv");
			m_Util_GetSystemAttributeInformationFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\Functions\\Util_GetSystemAttributeInformation.tsdrv");
			m_Util_ProvisioningPushFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\Functions\\Util_ProvisioningPush.tsdrv");
			m_Util_QueryUserHasActiveSystemFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\Functions\\Util_QueryUserHasActiveSystem.tsdrv");
			m_Util_ToOutputWindowFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\Functions\\Util_ToOutputWindow.tsdrv");
			m_VCenter_SystemOnOffFunctionInterpreter = CreateFunctionInterpreter("FastLab_CSDriver\\Functions\\VCenter_SystemOnOff.tsdrv");

        }
        
        public static int Main(string[] args)
        {
            FastLab_CSDriver driverInstance = new FastLab_CSDriver();
        ...
        internal class TestShellRuntimeLocator
        {
			...
			private static bool IsLicenseValid(TestShellRuntimeInfo testShellRuntimeInfo)
			{
                ...
                Assembly.GetExecutingAssembly().CodeBase, "QualiSystems.Driver.FastLab_CSDriver+TestShellRuntimeLocator+UnloadableLicenseValidator");
